! function (t) {
    if ("object" == typeof exports && "undefined" != typeof module) module.exports = t();
        ...
        var e;
        e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : this, e.qrcodelib = t()
    }
}(function () {
    return function t(e, r, n) {
        ...
        16: [function (t, e, r) {
            function n(t, e) {
                for (var r = t.size, n = m.getPositions(e), o = 0; o < n.length; o++)
            ...
            function i(t, e) {
                for (var r = w.getPositions(e), n = 0; n < r.length; n++)
                    for (var o = r[n][0], i = r[n][1], a = -2; a <= 2; a++)
                        for (var u = -2; u <= 2; u++) - 2 === a || 2 === a || -2 === u || 2 === u || 0 === a && 0 === u ? t.set(o + a, i + u, !0, !0) : t.set(o + a, i + u, !1, !0)
            }

            function a(t, e) {
                for (var r, n, o, i = t.size, a = B.getEncodedBits(e), u = 0; u < 18; u++) r = Math.floor(u / 3), n = u % 3 + i - 8 - 3, o = 1 == (a >> u & 1), t.set(r, n, o, !0), t.set(n, r, o, !0)
            }

            function u(t, e, r) {
                var n, o, i = t.size,
                    a = A.getEncodedBits(e, r);
            ...
            function f(t, e, r) {
                ...
                r.forEach(function (e) {
                    n.put(e.mode.bit, 4), n.put(e.getLength(), C.getCharCountIndicator(e.mode, t)), e.write(n)
                });
            ...
            function l(t, e, r) {
                for (var n = d.getSymbolTotalCodewords(e), o = E.getTotalCodewordsCount(e, r), i = n - o, a = E.getBlocksCount(e, r), u = n % a, s = a - u, f = Math.floor(n / a), l = Math.floor(i / a), c = l + 1, g = f - l, p = new b(g), v = 0, w = new Array(a), m = new Array(a), y = 0, B = new h(t.buffer), A = 0; A < a; A++) {
                    var C = A < s ? l : c;
                    w[A] = B.slice(v, v + C), m[A] = p.encode(w[A]), v += C, y = Math.max(y, C)
                }
                var N, T, I = new h(n),
                    M = 0;
                for (N = 0; N < y; N++)
                    for (T = 0; T < a; T++) N < w[T].length && (I[M++] = w[T][N]);
                for (N = 0; N < g; N++)
                    for (T = 0; T < a; T++) I[M++] = m[T][N];
                return I
            }

            function c(t, e, r) {
                var l;
                if (T(t)) l = N.fromArray(t);
                else {
                    if ("string" != typeof t) throw new Error("Invalid data");
                    var c = e;
                    if (!c) {
                        var h = N.rawSplit(t);
                        c = B.getBestVersionForData(h, r)
                    }
                    l = N.fromString(t, c || 40)
                }
                var g = B.getBestVersionForData(l, r);
                if (!g) throw new Error("The amount of data is too big to be stored in a QR Code");
                if (e) {
                    if (e < g) throw new Error("\nThe chosen QR Code version cannot contain this amount of data.\nMinimum version required to store current data is: " + g + ".\n")
                } else e = g;
                var p = f(e, r, l),
                    w = d.getSymbolSize(e),
                    m = new v(w);
                n(m, e), o(m), i(m, e), u(m, r, 0), e >= 7 && a(m, e), s(m, p);
                var E = y.getBestMask(m, u.bind(null, m, r));
                return y.applyMask(E, m), u(m, r, E), {
                    modules: m,
                    version: e,
            ...
            r.create = function (t, e) {
                ...
                var r, n = g.M;
                return void 0 !== e && (n = g.from(e.errorCorrectionLevel, g.M), r = B.from(e.version), e.toSJISFunc && d.setToSJISFunction(e.toSJISFunc)), c(t, r, n)
            }
        }, {
            "../utils/buffer": 26,
            "./alignment-pattern": 1,
        ...
        18: [function (t, e, r) {
            var n = "(?:[　-〿]|[぀-ゟ]|[゠-ヿ]|[＀-￯]|[一-龯]|[★-☆]|[←-↕]|※|[‐―‘’‥…“”∥≠]|[Α-ё]|[§¨±´×÷])+";
            r.KANJI = new RegExp(n, "g"), r.BYTE_KANJI = new RegExp("[^A-Z0-9 $%*+-./:]+", "g"), r.BYTE = new RegExp("(?:(?![A-Z0-9 $%*+-./:]|(?:[　-〿]|[぀-ゟ]|[゠-ヿ]|[＀-￯]|[一-龯]|[★-☆]|[←-↕]|※|[‐―‘’‥…“”∥≠]|[Α-ё]|[§¨±´×÷])+).)+", "g"), r.NUMERIC = new RegExp("[0-9]+", "g"), r.ALPHANUMERIC = new RegExp("[A-Z $%*+-./:]+", "g");
            var o = new RegExp("^" + n + "$"),
                i = new RegExp("^[0-9]+$"),
                a = new RegExp("^[A-Z0-9 $%*+-./:]+$");
        ...
        19: [function (t, e, r) {
            ...
            function i(t) {
                var e, r, n = o(v.NUMERIC, c.NUMERIC, t),
                    i = o(v.ALPHANUMERIC, c.ALPHANUMERIC, t);
                return w.isKanjiModeEnabled() ? (e = o(v.BYTE, c.BYTE, t), r = o(v.KANJI, c.KANJI, t)) : (e = o(v.BYTE_KANJI, c.BYTE, t), r = []), n.concat(i, e, r).sort(function (t, e) {
            ...
            function l(t, e) {
                ...
                switch (r !== c.KANJI || w.isKanjiModeEnabled() || (r = c.BYTE), r) {
                    case c.NUMERIC:
                        return new h(t);
                    case c.ALPHANUMERIC:
                        return new d(t);
            ...
            r.fromArray = function (t) {
                ...
                for (var n = i(t, w.isKanjiModeEnabled()), o = s(n), a = f(o, e), l = m.find_path(a.map, "start", "end"), c = [], h = 1; h < l.length - 1; h++) c.push(a.table[l[h]].node);
                return r.fromArray(u(c))
            }, r.rawSplit = function (t) {
                return r.fromArray(i(t, w.isKanjiModeEnabled()))
            }
        }, {
            "./alphanumeric-data": 2,
            "./byte-data": 5,
        ...
        21: [function (t, e, r) {
            ...
            function a(t, e) {
                for (var n = 1; n <= 40; n++) {
                    if (i(t, n) <= r.getCapacity(n, e, l.MIXED)) return n
                }
            }
            var u = t("./utils"),
            ...
            r.isValid = function (t) {
                ...
                return r.isValid(t) ? parseInt(t, 10) : e
            }, r.getCapacity = function (t, e, n) {
                if (!r.isValid(t)) throw new Error("Invalid QR Code version");
                void 0 === n && (n = l.BYTE);
                var i = u.getSymbolTotalCodewords(t),
                    a = s.getTotalCodewordsCount(t, e),
                    f = 8 * (i - a);
                if (n === l.MIXED) return f;
                var c = f - o(n, t);
                switch (n) {
                    case l.NUMERIC:
                ...
                if (!r.isValid(t) || t < 7) throw new Error("Invalid QR Code version");
                for (var e = t << 12; u.getBCHDigit(e) - h >= 0;) e ^= 7973 << u.getBCHDigit(e) - h;
                return t << 12 | e
            }
        }, {
            "./error-correction-code": 6,
        ...
        22: [function (t, e, r) {
            function n(t, e, r, n, i) {
                ...
                if (2 === a ? (i = r, r = e, e = n = void 0) : 3 === a && (e.getContext && void 0 === i ? (i = n, n = void 0) : (i = n, n = r, r = e, e = void 0)), "function" != typeof i) throw new Error("Callback required as last argument");
                try {
                    var u = o.create(r, n);
                    i(null, t(u, e, n))
                } catch (t) {
            ...
            var o = t("./core/qrcode"),
                i = t("./renderer/canvas"),
                a = t("./renderer/svg-render.js");
            r.create = o.create, r.toCanvas = n.bind(null, i.render), r.toDataURL = n.bind(null, i.renderToDataURL), r.toString = n.bind(null, function (t, e, r) {
                return a.render(t, r)
            }), r.qrcodedraw = function () {
                return {
                    draw: r.toCanvas
                }
            }
        ...
        23: [function (t, e, r) {
            ...
            r.render = function (t, e, r) {
                ...
                var s = (t.modules.size + 2 * a.margin) * a.scale,
                    f = u.getContext("2d"),
                    l = f.createImageData(s, s);
                return i.qrToImageData(l.data, t, a.margin, a.scale, a.color), n(f, u, s), f.putImageData(l, 0, 0), u
        ...
        24: [function (t, e, r) {
            function n(t) {
                return 'fill="rgb(' + [t.r, t.g, t.b].join(",") + ')" fill-opacity="' + (t.a / 255).toFixed(2) + '"'
            }
            var o = t("./utils");
            r.render = function (t, e) {
                var r = o.getOptions(e),
                    i = t.modules.size,
                    a = t.modules.data,
                    u = (i + 2 * r.margin) * r.scale,
                ...
                for (var f = 0; f < i; f++)
                    for (var l = 0; l < i; l++)
                        if (a[f * i + l]) {
                            var c = (r.margin + l) * r.scale,
                                h = (r.margin + f) * r.scale;
                            s += '<use x="' + c + '" y="' + h + '" xlink:href="#p" />\n'
                        }
                return s += "</g>\n", s += "</svg>"
            }
        }, {
        ...
        25: [function (t, e, r) {
            ...
            }, r.qrToImageData = function (t, e, r, n, o) {
                for (var i = e.modules.size, a = e.modules.data, u = r * n, s = i * n + 2 * u, f = [o.light, o.dark], l = 0; l < s; l++)
                    for (var c = 0; c < s; c++) {
                        var h = 4 * (l * s + c),
                            d = o.light;
                        if (l >= u && c >= u && l < s - u && c < s - u) {
                            var g = Math.floor((l - u) / n),
                                p = Math.floor((c - u) / n);
                            d = f[a[g * i + p]]
                        }
        ...
        26: [function (t, e, r) {
            ...
            function n(t, e, r) {
                return "number" == typeof t ? u(t) : v(t, e, r)
            }

            function o(t) {
                if (t >= m) throw new RangeError("Attempt to allocate Buffer larger than maximum size: 0x" + m.toString(16) + " bytes");
                return 0 | t
            }
            ...
            function f(t) {
                for (var e = t.length < 0 ? 0 : 0 | o(t.length), r = a(e), n = 0; n < e; n += 1) r[n] = 255 & t[n];
                return r
            }
            ...
            function l(t, e, r) {
                ...
                var o;
                return o = void 0 === e && void 0 === r ? new Uint8Array(t) : void 0 === r ? new Uint8Array(t, e) : new Uint8Array(t, e, r), o.__proto__ = n.prototype, o
            }
            ...
            function c(t) {
                ...
                if (t) {
                    if ("undefined" != typeof ArrayBuffer && t.buffer instanceof ArrayBuffer || "length" in t) return "number" != typeof t.length || i(t.length) ? a(0) : f(t);
            ...
            function v(t, e, r) {
                ...
                return "undefined" != typeof ArrayBuffer && t instanceof ArrayBuffer ? l(t, e, r) : "string" == typeof t ? s(t, e) : c(t)
            }
            var w = t("isarray"),
                m = 2147483647;
            n.prototype.__proto__ = Uint8Array.prototype, n.__proto__ = Uint8Array, "undefined" != typeof Symbol && Symbol.species && n[Symbol.species] === n && Object.defineProperty(n, Symbol.species, {
                value: null,
                configurable: !0,
                enumerable: !1,
                writable: !1
        ...
        27: [function (t, e, r) {
            ...
            var n = {
                single_source_shortest_paths: function (t, e, r) {
                    ...
                    a.push(e, 0);
                    for (var u, s, f, l, c, h, d, g; !a.empty();) {
                        u = a.pop(), s = u.value, l = u.cost, c = t[s] || {};
                        for (f in c) c.hasOwnProperty(f) && (h = c[f], d = l + h, g = i[f], (void 0 === i[f] || g > d) && (i[f] = d, a.push(f, d), o[f] = s))
                    }
